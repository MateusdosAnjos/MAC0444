...
\begin{document}
	...
	\begin{itemize}
		...
		\item[\textbf{3 -}]
			...
			$\forall x(_1 PaiDeMedicos(x) \rightarrow (_2\exists y(_3temFilho(x, y) \wedge (_4Homem(y) \vee Mulher(y))_4)_3 \wedge (_5\forall z (_6temFilho(x, z) \rightarrow Medico(z))_6)_5)_2)_1$
		\item[\textbf{4 -}]
	\end{itemize}
\end{document}